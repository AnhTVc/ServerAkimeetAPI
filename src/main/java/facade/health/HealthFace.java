...
public class HealthFace {

    /**
     * Find restaurant Health
     * @param limit
     * @param offset
     * @return
     */
    ...
    public String getEntertainment(@QueryParam("limit") int limit,
        ...
        ArrayList<Restaurant> restaurants = restaurantDAO.getRestaurantByType(Define.RESTAURANT_TYPE_HEALTH);
