...
@Path("/am-thuc")
public class CulinaryFace {
    /**
     * Find restaurant Culinary
     * @param limit
     * @param offset
     * @return
     */
    ...
    public String getEntertainment(@QueryParam("limit") int limit,
        ...
        ArrayList<Restaurant> restaurants = restaurantDAO.getRestaurantByType(Define.RESTAURANT_TYPE_CULINARY);
