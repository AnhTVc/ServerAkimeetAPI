 ...
 */
public class Main {
    private static final String URL = "/Users/nguyenmanhtuan/Documents/AnhTVc/other/1-Introductory/";
    ...
    private static ToiecTest getToiecTest(PDDocument document,
        ...
        try {
            ...
            if(indexBeginAnswer == 0){
                // Khong co cau tra loi cho question nay
            }
    ...
    public static void main(String[] arg){
        ...
        try {
            ...
            PDDocument document = PDDocument.load(new File(URL + "Book- Introductory Course(4Edition).pdf"));
            document.getClass();
            ...
            toiecTestOne = getToiecTest(document, 221, 260 -1, 367,
                    379,334,
                    340 );

            toiecTestTwo = getToiecTest(document, 260, 300,
                    379, 391, 340, 345);
            ...
            toiecTestFour = getToiecTest(document, pageIndexPageQuestionFour, 171,
                    pageIndexPageAnswerKeyFour, 252, pageIndexAudioScriptFour, 201);*/
